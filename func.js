...
document.addEventListener('DOMContentLoaded', () => {
  function hideAllOptionPanels() {
    const panels = [
      'colorOptions', 'fontOptions', 'layoutOptions',
      'icon-options', 'bubbleShapeOptions', 'avatarShapeOptions', 'shadowOptions'
    ];
    panels.forEach(id => document.getElementById(id)?.classList.add('hidden'));
    document.querySelectorAll('.customization-buttons button').forEach(btn => btn.classList.remove('active'));
  }
  ...
  function toggleColor() {
    ...
    hideAllOptionPanels();
    if (isHidden) { panel.classList.remove('hidden'); highlightActiveButton('colorBtn'); }
  }
  function toggleFont() {
    const panel = document.getElementById('fontOptions');
    const isHidden = panel.classList.contains('hidden');
    hideAllOptionPanels();
    if (isHidden) { panel.classList.remove('hidden'); highlightActiveButton('fontBtn'); }
  }
  function toggleLayout() {
    const panel = document.getElementById('layoutOptions');
    const isHidden = panel.classList.contains('hidden');
    hideAllOptionPanels();
    if (isHidden) { panel.classList.remove('hidden'); highlightActiveButton('layoutBtn'); }
  }
  function toggleSendIcon() {
    const panel = document.getElementById('icon-options');
    const isHidden = panel.classList.contains('hidden');
    hideAllOptionPanels();
    if (isHidden) { panel.classList.remove('hidden'); highlightActiveButton('sendIconBtn'); }
  }
  function toggleShape() {
    const panel = document.getElementById('bubbleShapeOptions');
    const isHidden = panel.classList.contains('hidden');
    hideAllOptionPanels();
    if (isHidden) { panel.classList.remove('hidden'); highlightActiveButton('shapeBtn'); }
  }
  function toggleAvatar() {
    const panel = document.getElementById('avatarShapeOptions');
    const isHidden = panel.classList.contains('hidden');
    hideAllOptionPanels();
    if (isHidden) { panel.classList.remove('hidden'); highlightActiveButton('avatarBtn'); }
  }
  function toggleShadow() {
    const panel = document.getElementById('shadowOptions');
    const isHidden = panel.classList.contains('hidden');
    hideAllOptionPanels();
    if (isHidden) { panel.classList.remove('hidden'); highlightActiveButton('shadowBtn'); }
  }
  ...
  function setSendIcon(type) {
    ...
    if (icons[type]) sendBtn.innerHTML = icons[type];
  }
